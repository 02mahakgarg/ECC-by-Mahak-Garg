                ...
                <div class="form-content">
                    ...
                    <form method = "post" action = "login.php">
                        ...
                        <div class="field button-field">
                            <input name = "submit" type="submit" value = "Login" style="background-color: blue; color: white;">
                        </div> <!--location.href='file:///C:/Users/dell/Desktop/food%20project/food%20project%20elders/home.html'-->
                    </form>
            ...
            <div class="form signup">
                <div class="form-content">
                    ...
                    <form method = "post" action = "connect.php">
                        ...
                        <div class="field input-field">
                            <input type="password" placeholder="Create password" name = "password" class="password" id="createpassword">
                        </div>
                        ...
                        </div> <!--onclick="location.href='file:///C:/Users/dell/Desktop/food%20project/food%20project%20elders/home.html'"-->
                    </form>
